...
import yaohf.com.tool.io.IOUtil;
...
public class DownloadManager {
    ...
    private DownloadManager(OkHttpClient okHttpClient) {
        if (okHttpClient == null) {
            mClient = OkHttpUtils.getOkHttpClient();
        }
    }
...
//                .subscribe((Consumer<? super Object>) downLoadObserver);//添加观察者
//
//    }
...
//
    ...
    private DownloadInfo getRealFileName(DownloadInfo downloadInfo) {
        ...
        while (downloadLength >= contentLength) {
            ...
            File newFile = new File(Environment.getExternalStorageDirectory().getAbsoluteFile(), fileNameOther);
            file = newFile;
    ...
    private class DownloadSubscribe implements ObservableOnSubscribe<DownloadInfo> {
        ...
        public void subscribe(ObservableEmitter<DownloadInfo> e) throws Exception {
            ...
            try {
                buffStream = new BufferedInputStream(response.body().byteStream());
                buffStream.mark(0);
                File file = new File(Environment.getExternalStorageDirectory().getAbsoluteFile(), downloadInfo.getFileName());
