package yaohf.com.widget.countdown;
...
public class CountDownProgressView extends View {
    ...
    public CountDownProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for(int i=0;i<indexCount;i++){
            ...
            if (attr == R.styleable.CountDownProgress_default_circle_solide_color) {
            ...
            } else if (attr == R.styleable.CountDownProgress_small_circle_solide_color) {
