...
public class HttpEngine {
    ...
    public <T> T postHandle(String url ,Map<String, String> paramsMap, Type typeOfT) throws IOException {
     ...
     * @throws IOException
     */
    public String postHandle(String requestUrl, String paramsMap, Type typeOfT) throws IOException {
...
//            return gson.fromJson(result, typeOfT);
    ...
    // 获取connection
    private HttpURLConnection getConnection(String requsetUrl ) {
